use salvo::prelude::{ToParameters, ToSchema};
...
#[derive(Clone, Debug, Default, Serialize, PartialEq, Deserialize, ToSchema, ToParameters)]
pub struct MiniAppLoginRequest {
    pub code: String,
    pub app_id: String,
}

#[derive(Clone, Debug, Default, Serialize, PartialEq, Deserialize, ToSchema)]
...
#[derive(Clone, Debug, Default, Serialize, Deserialize, ToSchema, ToParameters)]
